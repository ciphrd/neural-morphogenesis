...
export const GROWTH_SLIDER_SPECS: GrowthSliderSpec[] = [
  ...
  },
  {
    ...
    hint: "Controls one-sided placement along the neural growth direction. 1× can keep the parent fixed and place the daughter fully along that direction; 0 keeps the pair centered and symmetric.",
    min: 0,
    max: 1,
    step: 0.01,
    format: (v) => `${v.toFixed(2)}×`,
  },
  {
    ...
    hint: "For Lab tangent-growth scenarios, morphology gradients at or below this value are treated as flat. The selected tangent controls both growth and the centered split axis.",
    min: 0,
 ...
 * controls how strongly neural-direction splits are polarized;
