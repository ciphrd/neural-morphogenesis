...
| Deterministic forced growth | Lab/test only | Forced sample ranges, fixed directions, boundary tangent, and a radial-inward field override. The radial case deliberately injects an isotropic expansion tensor. |
