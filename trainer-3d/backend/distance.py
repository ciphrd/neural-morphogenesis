"""Generic point-cloud-to-target-volume distance. Deliberately works on
raw (N, 3) point arrays rather than the Graph type — it doesn't care
whether the points came from graph node positions, sampled mesh surface
points, or some future growth representation, only that geometry reduces
